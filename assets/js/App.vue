<template>
    <div id="app">
        <a class="github" href="https://github.com/jhenry82/magesim-tbc2/tree/prepatch" target="_blank"></a>
                ...
                <div class="config" v-if="config_open">
                    <div class="fieldsets">
                        ...
                        <fieldset>
                            ...
                            <div class="form-row" v-if="config.conjured && (config.conjured != conjureds.CONJURED_MANA_GEM && config.conjured != conjureds.CONJURED_MANA_GEM_ALL)">
                                <div class="form-item">
